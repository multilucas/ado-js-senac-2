...
funcs => {
    ...
    function mexer(oQue, naoFazer, verificador) {
        const objeto = oQue;
        try {
            como(objeto);
        } catch (e) {
    ...
    function testarConstrutorNota(erro, nota, peso) {
        try {
            ...
            if (erro === TypeError) {
                ...
                if (e.message !== "A nota e o peso devem ser um número entre 0 e 10.") throw new Error("A mensagem está errada.");
            }
            return;
        }
    ...
    grupo("Exercício 1 - parte 2 (caminho infeliz com TypeError)", "Construtor de Nota com parâmetros de tipo inválido").maximo(0.3).testes([
        teste("Nota null não está ok."     , () => testarConstrutorNota(TypeError,          null,          10  ), naoDeuErro(), testOk),
        teste("Peso null não está ok."     , () => testarConstrutorNota(TypeError,            10,          null), naoDeuErro(), testOk),
        teste("Nota undefined não está ok.", () => testarConstrutorNota(TypeError,     undefined,            10), naoDeuErro(), testOk),
        teste("Peso undefined não está ok.", () => testarConstrutorNota(TypeError,            10,     undefined), naoDeuErro(), testOk),
        teste("Nota NaN não está ok."      , () => testarConstrutorNota(TypeError,           NaN,            10), naoDeuErro(), testOk),
        teste("Peso NaN não está ok."      , () => testarConstrutorNota(TypeError,            10,           NaN), naoDeuErro(), testOk),
        teste("Nota string não está ok."   , () => testarConstrutorNota(TypeError,     "bug bug",            10), naoDeuErro(), testOk),
        teste("Peso string não está ok."   , () => testarConstrutorNota(TypeError,            10,     "bug bug"), naoDeuErro(), testOk),
        teste("Nota objeto não está ok."   , () => testarConstrutorNota(TypeError,     {bug:"x"},            10), naoDeuErro(), testOk),
        teste("Peso objeto não está ok."   , () => testarConstrutorNota(TypeError,            10,     {bug:"x"}), naoDeuErro(), testOk),
        teste("Nota abacaxi não está ok."  , () => testarConstrutorNota(TypeError, new Abacaxi(),            10), naoDeuErro(), testOk),
        teste("Peso abacaxi não está ok."  , () => testarConstrutorNota(TypeError,            10, new Abacaxi()), naoDeuErro(), testOk),
        teste("Nota infinita não está ok." , () => testarConstrutorNota(TypeError,      Infinity,            10), naoDeuErro(), testOk),
        teste("Peso infinita não está ok." , () => testarConstrutorNota(TypeError,            10,      Infinity), naoDeuErro(), testOk),
        teste("Nota -infinita não está ok.", () => testarConstrutorNota(TypeError,     -Infinity,            10), naoDeuErro(), testOk),
        teste("Peso -infinita não está ok.", () => testarConstrutorNota(TypeError,            10,     -Infinity), naoDeuErro(), testOk)
    ]);
    ...
    grupo("Exercício 1 - parte 3 (caminho infeliz com RangeError)", "Construtor de Nota com parâmetros de valores inválidos").maximo(0.3).testes([
        teste("Nota -5 não está ok."     , () => testarConstrutorNota(RangeError,   -5  ,   10  ), naoDeuErro(), testOk),
        teste("Peso -5 não está ok."     , () => testarConstrutorNota(RangeError,   10  ,   -5  ), naoDeuErro(), testOk),
        teste("Nota -0.1 não está ok."   , () => testarConstrutorNota(RangeError,   -0.1,   10  ), naoDeuErro(), testOk),
        teste("Peso -0.1 não está ok."   , () => testarConstrutorNota(RangeError,   10  ,   -0.1), naoDeuErro(), testOk),
        teste("Nota 10.1 não está ok."   , () => testarConstrutorNota(RangeError,   10.1,   10  ), naoDeuErro(), testOk),
        teste("Peso 10.1 não está ok."   , () => testarConstrutorNota(RangeError,   10  ,   10.1), naoDeuErro(), testOk),
        teste("Nota 9999 não está ok."   , () => testarConstrutorNota(RangeError, 9999  ,   10  ), naoDeuErro(), testOk),
        teste("Peso 9999 não está ok."   , () => testarConstrutorNota(RangeError,   10  , 9999  ), naoDeuErro(), testOk)
    ]);

    // Exercício 2.

    function testarGettersNota(nota) {
        return [nota.valor, nota.peso];
    }

    grupo("Exercício 2", "Getters de Nota").maximo(0.3).testes([
        teste("Nota 10 e peso 10 está ok."  , () => testarGettersNota(new Nota(10  , 10  )), igual([10  , 10  ]), testOk),
        teste("Nota 8 e peso 4 está ok."    , () => testarGettersNota(new Nota( 8  ,  4  )), igual([ 8  ,  4  ]), testOk),
        teste("Nota 2 e peso 3 está ok."    , () => testarGettersNota(new Nota( 2  ,  3  )), igual([ 2  ,  3  ]), testOk),
        teste("Nota 7.8 e peso 2.5 está ok.", () => testarGettersNota(new Nota( 7.8,  2.5)), igual([ 7.8,  2.5]), testOk),
        teste("Nota 0 e peso 10 está ok."   , () => testarGettersNota(new Nota(10  ,  0  )), igual([10  ,  0  ]), testOk),
        teste("Nota 10 e peso 0 está ok."   , () => testarGettersNota(new Nota( 0  , 10  )), igual([ 0  , 10  ]), testOk),
        teste("Nota 5 e peso 5 está ok."    , () => testarGettersNota(new Nota( 5  ,  5  )), igual([ 5  ,  5  ]), testOk),
    ]);
    ...
    grupo("Exercícios 2 e 3 - sem setters", "A classe Nota não tem setters ").maximo(0.2).testes([
        teste("Não pode setar valor."         , () => mexer(new Nota(5, 7), n => n.valor = 8        , n => n.valor         === 5  ), naoDeuErro(), testOk),
        teste("Não pode setar peso."          , () => mexer(new Nota(5, 7), n => n.peso = 8         , n => n.peso          === 7  ), naoDeuErro(), testOk),
        teste("Não pode setar nota ponderada.", () => mexer(new Nota(5, 7), n => n.notaPonderada = 8, n => n.notaPonderada === 3.5), naoDeuErro(), testOk),
    ]);
    ...
    const antes = "{ try { new AlunoMatricula";
    const meio = "; throw new Error('Aceitou porcaria'); } catch (e) { if (!(e instanceof ";
    const depois = ") || [null, undefined, ''].includes(e?.message?.trim())) throw e; } }";
        ...
        lista.forEach(aluno =>
            testes5p2.push(
                teste(
                    ...
                    eval(aluno.criar.replace("FUNC", antes) + meio + aluno.erro + depois),
                    naoDeuErro(),
                    testOk
                )
            )
    ...
    grupo("Exercícios 6 a 10 - sem setters", "A classe AlunoMatricula não tem setters ").maximo(0.2).testes([
        teste("Não pode setar nome."                , () => mexer(new AlunoMatricula("a", "M", "b", [new Nota(5, 10)], 77), a => a.nome       = "x" , a => a.nome        === "a" ), naoDeuErro(), testOk),
        teste("Não pode setar gênero."              , () => mexer(new AlunoMatricula("a", "M", "b", [new Nota(5, 10)], 77), a => a.genero     = "F" , a => a.genero      === "M" ), naoDeuErro(), testOk),
        teste("Não pode setar disciplina."          , () => mexer(new AlunoMatricula("a", "M", "b", [new Nota(5, 10)], 77), a => a.disciplina = "x" , a => a.disciplina  === "b" ), naoDeuErro(), testOk),
        teste("Não pode setar presença."            , () => mexer(new AlunoMatricula("a", "M", "b", [new Nota(5, 10)], 77), a => a.presenca   = 89  , a => a.presenca    === 77  ), naoDeuErro(), testOk),
        teste("Não pode setar média."               , () => mexer(new AlunoMatricula("a", "M", "b", [new Nota(5, 10)], 77), a => a.media      = 8   , a => a.media       === 5   ), naoDeuErro(), testOk),
        teste("Não pode setar situação."            , () => mexer(new AlunoMatricula("a", "M", "b", [new Nota(5, 10)], 77), a => a.situacao   = "AP", a => a.situacao    === "RM"), naoDeuErro(), testOk),
        teste("Não pode setar situação por extenso.", () => mexer(new AlunoMatricula("a", "M", "b", [new Nota(5, 10)], 77), a => a.situacaoPorExtenso = "aprovado", a => a.situacaoPorExtenso === "reprovado por média"), naoDeuErro(), testOk),
        teste("Não pode setar ADOs."                , () => mexer(new AlunoMatricula("a", "M", "b", [new Nota(5, 10)], 77), a => a.ados = [new Nota(9, 10), new Nota(9, 10)], a => a.ados.length === 1 && a.ados[0].valor === 5 && a.ados[0].peso === 10), naoDeuErro(), testOk),
    ]);
    ...
    function testarEfeitosColaterais(coisa, jsonBase) {
        ...
        const json1 = Utilitarios.jsonBonito(jsonBase, keys);
        const json2 = Utilitarios.jsonBonito(Utilitarios.extractGetters(coisa), keys);
        const json3 = Utilitarios.jsonBonito(Utilitarios.extractGetters(coisa, a => a.sort()), keys);
        const json4 = Utilitarios.jsonBonito(Utilitarios.extractGetters(coisa, a => a.sort().reverse()), keys);
        const json5 = Utilitarios.jsonBonito(Utilitarios.extractGetters(coisa, doido), keys);
        const json6 = Utilitarios.jsonBonito(Utilitarios.extractGetters(coisa, doido), keys);
        const json7 = Utilitarios.jsonBonito(Utilitarios.extractGetters(coisa, doido), keys);
    ...
    const testesColaterais1 = [`new Nota(4, 8)`, `new Nota(7, 3)`, `new Nota(0, 4)`, `new Nota(10, 2)`, `new Nota(10, 0)`].map((ctor, i) =>
        teste(
            `Deve se certificar que chamar os getters de Nota não causa efeitos colaterais estranhos [${i}].`,
            eval(`() => { const n = ${ctor}; testarEfeitosColaterais(n, {"valor": n.valor, "peso": n.peso}); }`),
            naoDeuErro(),
            testOk
        )
    );
    ...
    const testesColaterais2 = alunosMatriculasValidos.map(aluno =>
        teste(
            ...
            eval(`() => testarEfeitosColaterais(${aluno.criar.toString().replace("() => ", "")}, ${Utilitarios.jsonBonito(aluno.json)})`),
            naoDeuErro(),
            () => nomesOk && aluno.funcionastatus
        )
    );
    ...
    grupo("Exercício 14 - parte 2 (caminho infeliz)", "Construtor de Circulo com parâmetros de tipo inválido").maximo(0.3).testes([
        teste("Circulo null não está ok."     , () => testarConstrutorCirculo(TypeError , null         ), naoDeuErro(), testOk),
        teste("Circulo undefined não está ok.", () => testarConstrutorCirculo(TypeError , undefined    ), naoDeuErro(), testOk),
        teste("Circulo NaN não está ok."      , () => testarConstrutorCirculo(TypeError , NaN          ), naoDeuErro(), testOk),
        teste("Circulo string não está ok."   , () => testarConstrutorCirculo(TypeError , "bug bug"    ), naoDeuErro(), testOk),
        teste("Circulo objeto não está ok."   , () => testarConstrutorCirculo(TypeError , {bug:"x"}    ), naoDeuErro(), testOk),
        teste("Circulo abacaxi não está ok."  , () => testarConstrutorCirculo(TypeError , new Abacaxi()), naoDeuErro(), testOk),
        teste("Circulo infinito não está ok." , () => testarConstrutorCirculo(TypeError , Infinity     ), naoDeuErro(), testOk),
        teste("Circulo -infinito não está ok.", () => testarConstrutorCirculo(TypeError , -Infinity    ), naoDeuErro(), testOk),
        teste("Circulo -5 não está ok."       , () => testarConstrutorCirculo(RangeError, -5           ), naoDeuErro(), testOk),
        teste("Circulo -0.01 não está ok."    , () => testarConstrutorCirculo(RangeError, -0.01        ), naoDeuErro(), testOk)
    ]);

    function testarGetters2(circulo) {
        return [circulo.raio, circulo.diametro, circulo.area, circulo.circunferencia];
    }

    grupo("Exercício 14 - parte 3 (getters)", "Getters de Circulo").maximo(0.2).testes([
        teste("Raio 10 está ok."      , () => testarGetters2(new Circulo(  10   )), igual([  10   ,    20  ,      100      * Math.PI,    20   * Math.PI]), testOk),
        teste("Raio 35.25 está ok."   , () => testarGetters2(new Circulo(  35.25)), igual([  35.25,    70.5,     1242.5625 * Math.PI,    70.5 * Math.PI]), testOk),
        teste("Raio 9876.5 está ok."  , () => testarGetters2(new Circulo(9876.5 )), igual([9876.5 , 19753  , 97545252.25   * Math.PI, 19753   * Math.PI]), testOk),
        teste("Raio 0 está ok."       , () => testarGetters2(new Circulo(   0   )), igual([   0   ,     0  ,        0               ,     0            ]), testOk)
    ]);

    grupo("Exercício 14 - parte 4 (sem setters)", "A classe Circulo não tem setters ").maximo(0.1).testes([
        teste("Não pode setar raio."          , () => mexer(new Circulo(10), n => n.raio           = 8, n => n.raio           ===  10          ), naoDeuErro(), testOk),
        teste("Não pode setar diâmetro."      , () => mexer(new Circulo(10), n => n.diametro       = 8, n => n.diametro       ===  20          ), naoDeuErro(), testOk),
        teste("Não pode setar área."          , () => mexer(new Circulo(10), n => n.area           = 8, n => n.area           === 100 * Math.PI), naoDeuErro(), testOk),
        teste("Não pode setar circunferência.", () => mexer(new Circulo(10), n => n.circunferencia = 8, n => n.circunferencia ===  20 * Math.PI), naoDeuErro(), testOk)
    ]);
});
